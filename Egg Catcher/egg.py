...
catcher_width = 100
catcher_height = 100
catcher_x = canvas_width / 2 - catcher_width / 2
catcher_y = canvas_height - catcher_height - 20
catcher_x2 = catcher_x + catcher_width
catcher_y2 = catcher_y + catcher_height
catcher = c.create_arc(catcher_x, catcher_y, catcher_x2, catcher_y2, start = 200, extent = 140, style = 'arc', outline = catcher_color, width = 3)
...
def catch_check():
    (catch_x, catch_y, catch_x2, catch_y2) = c.coords(catcher)
    for egg in eggs:
        (egg_x, egg_y, egg_x2, egg_y2) = c.coords(egg)
        if catch_x < egg_x and egg_x2 < catch_x2 and catch_y2 - egg_y2 < 40:
            eggs.remove(egg)
            c.delete(egg)
